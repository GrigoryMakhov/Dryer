...
namespace Baraban.Models
{
    public class DataOutputModel
    {
        ...
        public DataOutputModel(DataInputModel DataInput)
        {
            ...
            _m.Wstart = _DataInput.Wstart;
            _m.Wend = _DataInput.Wend;
            _m.percentCp = _DataInput.percentCp;
            _m.percentHp = _DataInput.percentHp;
            _m.percentSp = _DataInput.percentSp;
            _m.percentOp = _DataInput.percentOp;
            _m.percentNp = _DataInput.percentNp;
            _m.percentAp = _DataInput.percentAp;
            _m.percentWp = _DataInput.percentWp;
            _m.t1 = _DataInput.t1;
            _m.t2 = _DataInput.t2;
            _m.alpha = _DataInput.alpha;
            _m.eta = _DataInput.eta;
            _m.tair = _DataInput.tair;
            _m.tgase = _DataInput.tgase;
            _m.tm1 = _DataInput.tm1;
            _m.Gt = _DataInput.Gt;
            _m.Him = _DataInput.Him;
            _m.k = _DataInput.k;
            _m.Cgase = _DataInput.Cgase;
            _m.Cmaterial = _DataInput.Cmaterial;
            _m.Cwet = _DataInput.Cwet;
            _m.enthalpy100 = _DataInput.enthalpy100;
            _m.D = _DataInput.D;
            _m.L = _DataInput.L;
